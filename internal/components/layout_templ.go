...
func Layout(data PageData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, " - Goforms</title><!-- Single CSS Entry Point --><link rel=\"stylesheet\" href=\"/static/css/main.css\"></head><body><nav><div class=\"container\"><a href=\"/\" class=\"logo\">Goforms</a><div class=\"nav-links\"><a href=\"/contact\">Contact Demo</a> <a href=\"https://github.com/jonesrussell/goforms\">GitHub</a></div></div></nav><main>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "</main><footer><div class=\"container\"><p>Created by <a href=\"https://github.com/jonesrussell\">Russell Jones</a></p></div></footer><!-- Theme Toggle Script --><script>\n\t\t\t// Use modern JavaScript features\n\t\t\tconst themeToggle = () => {\n\t\t\t\t// Get current theme or system preference\n\t\t\t\tconst getTheme = () => \n\t\t\t\t\tlocalStorage.getItem('theme') || \n\t\t\t\t\t(window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light');\n\n\t\t\t\t// Toggle between light and dark\n\t\t\t\tconst theme = getTheme() === 'dark' ? 'light' : 'dark';\n\t\t\t\t\n\t\t\t\t// Update DOM and storage\n\t\t\t\tdocument.documentElement.dataset.theme = theme;\n\t\t\t\tlocalStorage.setItem('theme', theme);\n\t\t\t};\n\n\t\t\t// Initialize theme\n\t\t\tdocument.documentElement.dataset.theme = \n\t\t\t\tlocalStorage.getItem('theme') || \n\t\t\t\t(window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light');\n\n\t\t\t// Expose toggle function\n\t\t\twindow.toggleTheme = themeToggle;\n\t\t</script></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
